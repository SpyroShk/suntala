...
const AddProduct = () => {
	...
	// 	"carAvailability": 0,
	// 	"carNoOfRent": "string",
	// 	"carLastRented": "2023-04-28T18:19:35.338Z",
	// 	"carImage": "string"
	//   }
	...
	const handleSubmit = async (e) => {
		...
		try {
			...
			await axios.post(`${url.proxy_api}cars`, product).then((res) => {
					...
					<div className="form-wrapper">
						...
						>
							<div className="row">
								...
								<div className="col-12">
									<div className="form-inner">
										<label>NoOfRent</label>
										{/*<input type="text" name="message" placeholder="Product Description"/>*/}
										<textarea
											name="message"
											placeholder="No. of Rents"
											value={noOfRent}
											onChange={(e) => setNoOfRent(e.target.value)}
										/>
									</div>
								</div>
								<div className="col-12">
